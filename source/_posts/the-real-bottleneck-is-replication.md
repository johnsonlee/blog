...
最近我一直在找下一批能把估值体系打穿的 high alpha。起点很俗：GEV 之后还有谁？SNDK 之后还有谁？候选清单列了一长串，我扫到最后，发现里面没有 SpaceX。
...
“下一只 GEV 是谁？”“下一只 SNDK 是谁？”这种问题最后一定会得到一张 list。问题是，list 只能总结已经发生的事情。等所有人都知道 GPU、燃机和 memory 是瓶颈，最肥的一段 re-rating 往往已经结束。基本面可以继续很好，alpha 却开始往别处跑。
