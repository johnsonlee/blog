...
这阵子所有人都在喊 AI PC。微软推 Copilot+ PC，Intel、AMD、Qualcomm 排着队讲 NPU，NVIDIA 把 RTX AI PC、Personal AI Supercomputer 往前推。然后 WWDC 来了，苹果一句"AI PC"都没说。

<!-- more -->

但如果你把 WWDC 和这波 AI PC 叙事放在一起看，会发现一件反常识的事：**喊得最响的不是做得最彻底的，做得最彻底的那个根本没喊。**
...
苹果 WWDC 的意义就在这里。它没把自己包装成一家 AI PC 公司，但它做的恰恰是 AI PC 时代最核心的那件事：

> 把 AI 从云端的一个应用，变成设备和操作系统的默认能力。

所谓 PC 新时代，从来不是 PC 又回到了中心。是个人计算设备重新成为 AI 推理、上下文和任务调度的中心。

苹果不需要"AI PC"这个词，因为它已经握住了那个词底下的东西。
