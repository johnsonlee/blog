...
const INLINE_STYLES = {
  ...
  p: 'margin:0 0 18px;text-align:justify;font-size:16px;line-height:1.78;color:' + TEXT + ';',
  h1: 'margin:34px 0 18px;text-align:left;font-size:22px;line-height:1.4;font-weight:700;color:#111827;',
  h2: 'margin:34px 0 16px;text-align:left;padding:0;font-size:20px;line-height:1.45;font-weight:700;color:#111827;',
  h3: 'margin:28px 0 14px;text-align:left;font-size:18px;line-height:1.5;font-weight:700;color:#111827;',
  h4: 'margin:24px 0 12px;text-align:left;font-size:17px;line-height:1.5;font-weight:700;color:#111827;',
  blockquote: 'border-left:3px solid #0969da;margin:0;text-align:justify;padding:0.2em 1em;color:#656d76;',
  blockquoteParagraph: 'margin:0 0 10px;text-align:justify;font-size:16px;line-height:1.75;color:#656d76;',
  ul: 'margin:0 0 18px 0;text-align:justify;padding-left:24px;color:' + TEXT + ';',
  ol: 'margin:0 0 18px 0;text-align:justify;padding-left:24px;color:' + TEXT + ';',
  li: 'margin:0 0 8px;text-align:justify;font-size:16px;line-height:1.75;color:' + TEXT + ';',
  ...
  pre: 'margin:22px 0;text-align:left;padding:14px 16px;background:#f6f8fa;border:1px solid #e5e7eb;border-radius:6px;white-space:pre-wrap;word-break:break-word;line-height:1.65;font-size:14px;color:#111827;overflow-x:auto;',
...
function renderWechatPost(post, config) {
  ...
  return [
    ...
    '  <main style="box-sizing:border-box;text-align:justify;max-width:677px;margin:0 auto;padding:28px 16px 42px;background:#ffffff;font-family:' + FONT_FAMILY + ';">',
    '    <h1 style="margin:0 0 12px;text-align:left;font-size:26px;line-height:1.35;font-weight:700;color:#111827;letter-spacing:0;">' + title + '</h1>',
    '    <p style="margin:0 0 28px;text-align:left;font-size:14px;line-height:1.6;color:' + MUTED + ';">' + escapeHtml(meta) + '</p>',
    renderWechatContent(post.content, permalink, lang),
    '    <section style="margin:34px 0 0;text-align:left;padding-top:18px;border-top:1px solid #e5e7eb;">',
    '      <p style="margin:0;text-align:left;font-size:14px;line-height:1.7;color:' + MUTED + ';">' + escapeHtml(originalLabel) + '：<a href="' + escapeHtml(permalink) + '" style="' + INLINE_STYLES.a + '">' + escapeHtml(permalink) + '</a></p>',
    '    </section>',
    '  </main>',
    '</body>',
    '</html>'
