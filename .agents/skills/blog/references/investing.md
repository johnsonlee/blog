...
讨论公司价值捕获或估值的文章，先把一笔生意怎样发生讲清楚。文章是否在做 alpha 分析，应由约束、价值捕获、市场隐含预期和证伪条件体现，不靠反复说“投资”“投资者”“机会”或“alpha”。仅叙述交易经历、比较方法或探索产业问题，不因分类为 Investing 就强加公司与估值章节；一旦作出公司受益或价格判断，仍须遵守对应证据门槛。
